...
public class AdminUpdateDeleteTeachersForm extends JFrame {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				try {
					...
					psCities = conn.prepareStatement(sqlCities, ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
					psCities.setString(1, sql);
	...
	deleteBtn.setForeground(new Color(255, 69, 0));
	deleteBtn.setBounds(322, 432, 117, 29);
	contentPane.add(deleteBtn);
	
	updateBtn = new JButton("UPDATE");
	updateBtn.setForeground(Color.BLUE);
	updateBtn.setBounds(157, 432, 117, 29);
