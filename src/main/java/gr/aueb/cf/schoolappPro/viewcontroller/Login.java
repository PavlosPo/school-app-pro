...
//			}
//		});
//		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/src/main/resources/eduv2.png")));
		setTitle("Login");
...
//		lblNewLabel.setIcon(new ImageIcon(Objects.requireNonNull(Login.class.getResource("/Users/pavlospoulos/IdeaProjects/school-app-pro/src/main/resources/school.jpg"))));
		...
		loginBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (usernameTxt.getText().matches("[aA]dmin")) {
					if (inputPasswd.matches("[aA]dmin")) {
